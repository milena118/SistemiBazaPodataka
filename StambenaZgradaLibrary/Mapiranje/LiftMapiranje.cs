...
{
    internal class LiftMapiranje : ClassMap<Entiteti.Lift>
    {
    ...
    internal class PutnickiLiftMapiranje : SubclassMap<Entiteti.PutnickiLift>
    {
    ...
    internal class TeretniLiftMapiranje : SubclassMap<Entiteti.TeretniLift>
    {
